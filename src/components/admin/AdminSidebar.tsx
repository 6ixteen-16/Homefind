...
import {
  ...
  ChevronLeft, ChevronRight, LogOut, BarChart3, Users2, Package,
} from "lucide-react";
...
const SETTINGS_ITEMS: NavItem[] = [
  { href: "/admin/agencies", label: "Agencies", icon: Building2, roles: ["SUPER_ADMIN"] },
  { href: "/admin/packages", label: "Listing Packages", icon: Package, roles: ["SUPER_ADMIN"] },
